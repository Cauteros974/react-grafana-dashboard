...
export const updateData = (type) => {
  switch (type) {
    case "bar":
      return (dispatch) =>
        dispatch(updateBarData(randomData.generateBarData()));
    case "spiral":
      return (dispatch) =>
        dispatch(updateSpiralData(randomData.generateSpiralData()));
    case "line":
      return (dispatch) =>
        dispatch(updateLineData(randomData.generateLineData()));
    default:
      return null;
  }
};
